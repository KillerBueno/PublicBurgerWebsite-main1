...
export default function CartPanel({ items, onRemove, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-stretch justify-end">
      ...
      {/* Panel */}
      <motion.div
        className="relative w-full max-w-sm bg-white flex flex-col shadow-2xl"
        ...
        <div className="px-6 py-5 border-t border-black/8 shrink-0 bg-white space-y-4">
            ...
            {orderType === 'asporto' && (
              ...
              >
                ...
                <input
                  ...
                  className="w-full border border-black/15 px-4 py-3 text-sm focus:outline-none focus:border-[#CF6990] placeholder-black/25 uppercase tracking-wide"
                />
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-black/15 px-4 py-3 text-sm focus:outline-none focus:border-[#CF6990] text-black/70 tracking-wide"
            />
          ...
          <button
            ...
            className="w-full py-4 bg-[#25D366] text-white text-xs uppercase tracking-widest font-bold flex items-center justify-center gap-3 hover:bg-[#1ebe5d] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
          >
