  ...
  return (
    <>
      ...
      <div className="bg-white text-[#1a0a10] antialiased overflow-x-hidden">
        ...
        {/* ── Reviews ── */}
        <section className="px-6 md:px-16 py-16 md:py-24 max-w-5xl mx-auto w-full">
          <Reveal>
            <p className="text-[10px] uppercase tracking-[0.35em] text-[#CF6990] font-bold mb-8">Le nostre recensioni</p>
          </Reveal>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Google */}
            <Reveal delay={0.05}>
              <div className="border border-black/8 rounded-2xl p-6 flex flex-col gap-3 hover:border-[#CF6990]/30 transition-colors duration-300">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] uppercase tracking-[0.2em] text-black/40 font-semibold">Google</span>
                </div>
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-[#1a0a10] tracking-tight">4,8</span>
                  <span className="text-[#CF6990] text-lg font-semibold">/5</span>
                </div>
                <div className="flex gap-0.5">
                  {[1,2,3,4,5].map(i => (
                    <svg key={i} viewBox="0 0 20 20" className={`w-4 h-4 ${i <= 4 ? 'text-[#FBBC05]' : 'text-[#FBBC05]'}`} fill="currentColor">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                    </svg>
                  ))}
                </div>
                <p className="text-[11px] text-black/35 tracking-wide">115 recensioni</p>
              </div>
            </Reveal>
              ...
              <div className="border border-black/8 rounded-2xl p-6 flex flex-col gap-3 hover:border-[#CF6990]/30 transition-colors duration-300">
                <div className="flex items-center gap-2">
                  <svg viewBox="0 0 24 24" className="w-5 h-5 shrink-0" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M12 5c-3.866 0-7 3.134-7 7s3.134 7 7 7 7-3.134 7-7-3.134-7-7-7zm0 11.5c-2.485 0-4.5-2.015-4.5-4.5S9.515 7.5 12 7.5s4.5 2.015 4.5 4.5-2.015 4.5-4.5 4.5z" fill="white"/>
                    <circle cx="12" cy="12" r="2" fill="white"/>
                  </svg>
                  <span className="text-[11px] uppercase tracking-[0.2em] text-black/40 font-semibold">Deliveroo</span>
                </div>
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-[#1a0a10] tracking-tight">4,7</span>
                  <span className="text-[#CF6990] text-lg font-semibold">/5</span>
                </div>
                <div className="flex gap-0.5">
                  {[1,2,3,4,5].map(i => (
                    <svg key={i} viewBox="0 0 20 20" className="w-4 h-4 text-[#FBBC05]" fill="currentColor">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                    </svg>
                  ))}
                </div>
                <p className="text-[11px] text-black/35 tracking-wide">112 recensioni · Eccellente</p>
              </div>
            </Reveal>
              ...
              <div className="border border-black/8 rounded-2xl p-6 flex flex-col gap-3 hover:border-[#CF6990]/30 transition-colors duration-300">
                <div className="flex items-center gap-2">
                  <svg viewBox="0 0 24 24" className="w-5 h-5 shrink-0" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text x="4" y="17" fontSize="12" fontWeight="bold" fill="white">JE</text>
                  </svg>
                  <span className="text-[11px] uppercase tracking-[0.2em] text-black/40 font-semibold">Just Eat</span>
                </div>
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-[#1a0a10] tracking-tight">4,9</span>
                  <span className="text-[#CF6990] text-lg font-semibold">/5</span>
                </div>
                <div className="flex gap-0.5">
                  {[1,2,3,4,5].map(i => (
                ...
                <p className="text-[11px] text-black/35 tracking-wide">440+ recensioni verificate</p>
              </div>
            </Reveal>
          </div>
